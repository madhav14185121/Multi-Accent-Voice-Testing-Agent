...
export const Navbar = React.memo(function Navbar() {
  return (
    <motion.nav 
      ...
      className="w-full flex justify-between items-center px-8 py-6 max-w-7xl mx-auto absolute top-0 z-50 left-0 right-0"
    >
      <a href="/" className="text-2xl font-semibold tracking-tighter text-foreground hover:text-accent-purple transition-colors">
        ARIA
      </a>
      <div className="hidden md:flex items-center gap-8 text-sm font-medium text-foreground/70">
        ...
        <a href="/history" className="hover:text-accent-purple transition-colors flex items-center gap-2"><Clock size={16} /> History</a>
